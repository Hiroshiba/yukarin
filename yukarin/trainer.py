from chainer import cuda, optimizers, serializers, training
...
def create_trainer(
    ...
    trainer.extend(extensions.PrintReport(['iteration', 'predictor/loss', 'test/predictor/loss']), trigger=trigger_log)
